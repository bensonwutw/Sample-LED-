...
#define TAU0_CHANNEL0_DIVISOR                   (256U)
/* 16-bit timer data register 01 (TDR01) */
#define _927B_TAU_TDR01_VALUE                   (0x927BU)
/* Clock divisor for TAU0 channel 1 */
#define TAU0_CHANNEL1_DIVISOR                   (128U)
/* 16-bit timer data register 02 (TDR02) */
#define _493D_TAU_TDR02_VALUE                   (0x493DU)
/* Clock divisor for TAU0 channel 2 */
#define TAU0_CHANNEL2_DIVISOR                   (128U)
