...
extern uint8_t g_sw1_pressed,g_sw1_hold,g_sw2_pressed,g_sw2_hold,g_sw3_pressed,g_sw3_hold;
/* End user code. Do not edit comment generated here */
...
__interrupt static void r_intc0_interrupt(void)
{
    ...
    if (P13.7 == 0) 
    {
    g_sw1_enable_sample = 1u; /* Start Sampling */
    g_sw1_period = 0u;
    }
    else
    {	 
    	if (g_sw1_enable_sample == 1)
    		{
    		if (g_sw1_period < 5) 
    		g_sw1_pressed = 1;
    		else g_sw1_hold = 1;
    		g_sw1_enable_sample = 0u; /* Completed Sampling  */
    		}
     }
